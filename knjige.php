...
session_start();
   ...
   $upit = "SELECT naziv_knjige,autor FROM knjige";
   ...
   if(isset($_POST['btnSubmit'])){
    ...
    $naziv_knjige= mysqli_real_escape_string($conn, $naziv_knjige);
    $autor= mysqli_real_escape_string($conn, $autor);
    $upit="INSERT INTO knjige (zanr_id,naziv_knjige,autor,naziv_zanra) VALUES ('{$zanr_id}','{$naziv_knjige}','{$autor}','{$naziv_zanra}')";
...
//   ?> -->
                ...
                <div class="col-lg-10 col-md-12  my-auto pb-4 mbr-form">
                    ...
                    <form action="" method="post" class="mbr-form form-with-styler" data-form-title="Form Name"><input
                        ...
                        <div class="dragArea form-row">
                            <div class="col-lg-12">
                                <h5 class="mbr-fonts-style display-2">Dodajte knjigu</h5>
                            </div>
    ...
    <section class="extTable section-table cid-sDlmrIqRJN" id="extTable1-1l">
                            ...
                            <table class="table  mx-auto" cellspacing="0">
                                <thead>
                                    <tr class="table-heads">
                                        ...
                                        <th class="head-item mbr-fonts-style display-5">Knjiga</th>
                                        <th class="head-item mbr-fonts-style display-5">Autor</th>
                                        <th class="head-item mbr-fonts-style display-5">Akcije</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href=<?php echo 'edit.php?id=' . $red['naziv_knjige']; ?>>Edit</a></td>
                                        <td><a href=<?php echo 'deleted.php?id=' . $red['naziv_knjige']; ?>>Delete</a></td>
                                    </tr>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-sm-12">
                    <h3 class="inner-text mbr-fonts-style content-text display-7">
                        Aplikaciju izradio <a href="https://kreativan-sajt.com/" class="text-primary">Kreativan
                            Sajt</a>. Sva prava
                        zadržana.</h3>
                </div>
