...
include "konekcija.php"; // Using database connection file here

$id= $_GET['id']; // get id through query string

$qry = mysqli_query($conn,"select * from knjige where id=$id"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($conn,"update knjige set  zanr_id='$zanr_id', naziv_knjige='$naziv_knjige' ,autor='$autor', naziv_zanra='$naziv_zanra' where id=$id");
	
    if($edit)
    {
        mysqli_close($conn); // Close connection
        header("location:knjige.php"); // redirects to all records page
        exit;
    }
    else
    {
                ...
                <div class="col-lg-10 col-md-12  my-auto pb-4 mbr-form">
                    ...
                    <form action="" method="post" class="mbr-form form-with-styler" data-form-title="Form Name"><input
                        ...
                        <div class="dragArea form-row">
                            <div class="col-lg-12">
                                <h5 class="mbr-fonts-style display-2">Ažurirajte knjigu</h5>
                            </div>
                            ...
                            <div class="col-auto">
                                <button type="update" name="update" class="btn btn-primary display-7">AŽURIRAJ</button>
                            </div>
                        </div>
                    </form>
                    <!--Formbuilder Form-->
